...
if 'username' not in st.session_state:
    ...
    html_content = html_content.replace('<a class="get-started-button" href="authentication" target="_self">Get Started</a></div>', name)
    st.markdown(html_content, unsafe_allow_html=True)
...
with st.container():
    ...
    with left_column:
        ...
        st.write(chat)
    with right_column:
        st_lottie(lottie_chatbot, height=300, key="chatbot",quality="high")
...
with st.container():
    ...
    with left_column:
        ...
        st.write(courses)
    with right_column:
        st_lottie(lottie_courses, height=300, key="courses",quality="high")
